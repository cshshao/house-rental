...
public class FangwuxinxiController {
    ...
    public R page(@RequestParam Map<String, Object> params,FangwuxinxiEntity fangwuxinxi,
		...
		if(tableName.equals("yonghu")) {
			fangwuxinxi.setGerenzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R vote(@PathVariable("id") String id,String type){
        FangwuxinxiEntity fangwuxinxi = fangwuxinxiService.selectById(id);
        if(type.equals("1")) {
        	fangwuxinxi.setThumbsupnum(fangwuxinxi.getThumbsupnum()+1);
        } else {
        	fangwuxinxi.setCrazilynum(fangwuxinxi.getCrazilynum()+1);
        }
