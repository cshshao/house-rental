  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(225, 225, 225, 1);borderRadius:26px">
        <h1 class="h1" style="color:rgba(244, 91, 75, 1);fontSize:28px;">房屋出租注册</h1>
		<el-form ref="rgsForm" class="rgs-form" label-width="120px">
			...
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.shenfenzhenghaoma" class="input" type="text" placeholder="身份证号码">
			   </div>
			 </div> -->
			<el-form-item label="身份证号码" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.shenfenzhenghaoma" autocomplete="off" placeholder="身份证号码"  />
			</el-form-item>
			<!-- <div v-if="tableName=='yonghu'" class="input-group">
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if(`yonghu` == this.tableName && this.ruleForm.shenfenzhenghaoma&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzhenghaoma))){
        this.$message.error(`身份证号码应输入身份证格式`);
        return
      }
