<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="房屋编号" prop="fangwubianhao">
          <el-input v-model="ruleForm.fangwubianhao" 
              placeholder="房屋编号" clearable  :readonly="ro.fangwubianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="房屋编号" prop="fangwubianhao">
              <el-input v-model="ruleForm.fangwubianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出租方式" prop="chuzufangshi">
          <el-input v-model="ruleForm.chuzufangshi" 
              placeholder="出租方式" clearable  :readonly="ro.chuzufangshi"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="发布日期" prop="faburiqi">
          <el-input v-model="ruleForm.faburiqi" 
              placeholder="发布日期" clearable  :readonly="ro.faburiqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
