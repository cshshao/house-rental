    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '区域' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.quyu" placeholder="区域" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.quyu" placeholder="区域" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.quyu" placeholder="区域" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '房租' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.fangzu" placeholder="房租" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.fangzu" placeholder="房租" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.fangzu" placeholder="房租" clearable></el-input>
                </el-form-item>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('fangwuxinxi','立即下单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="dingdanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'立即下单':'' }}</el-button>
                <el-button v-if="isAuth('fangwuxinxi','立即下单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="dingdanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'立即下单':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('fangwuxinxi','立即下单') && contents.tableBtnIcon == 0" type="success" size="mini" @click="dingdanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'立即下单':'' }}</el-button>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.fangzu!='' && this.searchForm.fangzu!=undefined){
            params['fangzu'] = '%' + this.searchForm.fangzu + '%'
          }
